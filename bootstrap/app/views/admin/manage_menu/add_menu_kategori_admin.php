            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     Manage <?php echo $function; ?>  Add Category <a href="#"><i class="icon-reorder"></i></a>
                   </h3>
                   <ul class="breadcrumb">
                       <li>
                       ...
                       <li>
                           <a href="#">Manage <?php echo $function; ?> Add Category </a>
            ...
            <div class="row-fluid">
                ...
                <!-- Penambahan Widget Philtyphil -->
                    <div class="widget purple">
                        ...
                        <h4><i class="icon-tasks"></i> <?php echo $function; ?> Add Category </h4>
                            <span class="tools">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="tabsleft-tab1">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
												<select onchange="getMenu();" id="submenus" data-placeholder="Sub menu" class="chzn-select span6" >
													<?php foreach($menu as $key => $value):?>
														<option value="<?php echo $value['id_main'].'-'.$value['nama_menu'];?>"><?php echo $value["nama_menu"];?></option>
													<?php endforeach; ?>
												</select>
                                               
                                                <span class="help-inline">Pilih menu</span>
                                            </div>
                                        </div>
										 <div class="control-group">
                                            <label class="control-label">Sub Menu</label>
                                            <div class="controls">
												<input type="text" onchange="getSubMenu(this.value);" class="span6">
												 <span class="help-inline">Isikan dengan submenu</span>
                                            </div>
                                        </div>
										...
										<div class="control-group">
                                            ...
                                            <div class="controls">
												<input id="aktif_menu" name="aktif" value="Y" type="radio" checked="checked"> Yes
												<br/>
												<input id="aktif_menu" name="aktif" value="N" type="radio"> No
											</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="tabsleft-tab3">
										...
										<div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="iconselect" onchange="getDesc(this.value)" class="span6" />
                                                <span class="help-inline"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tabsleft-tab4">
										...
										<div class="control-group">
                                            ...
                                            <div class="controls input-icon left">
												<i id="icon_input"></i>
                                                <input type="text" style="width:160px;" readonly="readonly" id="desc_menu">
                                            </div>
                                        </div>
                                        <div class="control-group">
