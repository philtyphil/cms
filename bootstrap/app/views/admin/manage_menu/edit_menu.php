                        ...
                        <div class="widget-body">
                            <form action="#" class="form-horizontal" >
                                ...
                                <div class="control-group " id="menu_edit_username">
                                     <label class="control-label" for="inputError">Menu</label>
                                     <div class="controls">
                                         <input type="text" id="edit_username_menu" class="span6 popovers" value="<?php echo $data[0]['nama_menu'];?>" data-trigger="hover" data-content="Insert Your Username" data-original-title="Insert name" required=""/>
								...
								<div class="control-group " id="menu_edit_username">
                                     ...
                                     <div class="controls">
										<select id="submenu_selected" data-placeholder="Your Already Sub Menu" class="chzn-select span6" multiple="multiple" >
											<?php foreach($submenu as $key => $value): ?>
												<?php if($value['id_main'] == $id): ?>
												<option selected value="<?php echo $value["id_sub"]?>" ><?php echo $value["nama_sub"];?></option>
												<?php else: ?>
												<option  value="<?php echo $value["id_sub"]?>" ><?php echo $value["nama_sub"];?></option>
												<?php endif; ?>
											<?php endforeach; ?>
                                ...
                                <div class="control-group" id="menu_edit_icon">
                                     ...
                                     <div class="controls">
                                         <input type="text" id="iconselect" value="<?php echo $data[0]['icon'];?>" class="span6  popovers" data-trigger="hover" data-content="Select icon menu" data-original-title="Select icon" />
                                 ...
                                 <div class="control-group" id="menu_edit_link">
                                     ...
                                     <div class="controls">
                                         <input type="text" id="edit_link" class="span6 popovers"value="<?php echo $data[0]['link'];?>" data-trigger="hover" data-content="Link Url" data-original-title="Link" required=""/>
                                 ...
                                 <div class="form-actions">
                                     ...
                                     <a href="<?php echo config_item("base_url")."admin";?>"><button type="button" class="btn">Cancel</button></a>
                                 </div>
                             </form>
                        </div>
                    </div>
