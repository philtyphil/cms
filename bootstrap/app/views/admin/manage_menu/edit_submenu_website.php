               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">Manage <?php echo $function; ?> Edit Submenu Website</a>
            ...
            <div class="row-fluid">
                ...
                <!-- Penambahan Widget Philtyphil -->
                    <div class="widget red">
                        ...
                        <h4><i class="icon-tasks"></i> <?php echo $function; ?> edit  Submenu Website</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <div action="#" class="form-horizontal" >
                                ...
                                <div class="control-group " id="menu_edit_username">
                                     ...
                                     <div class="controls">
                                         <input type="text" readonly="readonly" id="edit_name" class="span6 popovers" value="<?php echo $data[0]['nama_menu'];?>" data-trigger="hover" data-content="It is Your Subname" data-original-title="Main Menu (disabled)" required=""/>
								 ...
								 <div class="control-group " id="menu_edit_getSubMenu">
									...
									<div class="controls">
										...
										<select onchange="getSubMenu();" id="submenus" data-placeholder="Sub menu" class="chzn-select span6" multiple="multiple" readonly="readonly">
													...
													<?php endforeach; ?>
													<?php foreach($allsubmenu as $key => $value):?>
