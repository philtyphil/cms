						...
						<div class="widget-body" id="">
								<div class="tabbable ">
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#widget_tab1" data-toggle="tab">Manage Notification</a></li>
									</ul>
									...
									<!-- Begin Of Widget Tab 1 -->
										<div class="tab-pane active" id="widget_tab1">
											...
											<div class="control-group">
												<label class="control-label">Your Notification</label>
												<div class="controls">
													<input type="text" id="Notification" class="tooltips" data-trigger="hover" data-original-title="Masukan notifikasi anda!!" />
												</div>
												
											</div>
											
											<div class="form-actions">
												<button  class="btn btn-success tooltips" onclick="save();" data-trigger="hover" data-original-title="Click to save">Save!</button>
												<button type="submit" class="btn" onclick="window.location.href='<?php echo config_item("base_url")."notification";?>'">Cancel</button>
											</div>
