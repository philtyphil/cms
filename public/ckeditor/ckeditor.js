...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {
            ...
            basePath: function () {
                ...
                if (!b)
                    for (var d = document.getElementsByTagName("script"), a = 0; a < d.length; a++) {
            ...
            domReady: function () {
                function b() {
                    try {
                        document.addEventListener ? (document.removeEventListener("DOMContentLoaded", b, !1), d()) : document.attachEvent && "complete" === document.readyState && (document.detachEvent("onreadystatechange", b), d())
                    } catch (a) {}
                }
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {}, CKEDITOR.event.implementOn = function (a) {
        ...
        b.prototype = {
            getListenerIndex: function (b) {
                for (var d = 0, a = this.listeners; d < a.length; d++)
                    if (a[d].fn == b) return d;
                return -1
            }
        };
        return {
            ...
            fire: function () {
                ...
                return function (n, i, j) {
                    ...
                    if (o) {
                        var s = o.listeners;
                        if (s.length)
                            for (var s = s.slice(0), u, f = 0; f < s.length; f++) {
                                if (o.errorProof) try {
                                    u = s[f].call(this,
                                        j, i, d, g)
                                } catch (p) {} else u = s[f].call(this, j, i, d, g);
        ...
        CKEDITOR.tools = {
            ...
            extend: function (b) {
                var a = arguments.length,
                    d, h;
                if (typeof (d = arguments[a - 1]) == "boolean") a--;
                else if (typeof (d = arguments[a - 2]) == "boolean") {
                    h = arguments[a - 1];
                    a = a - 2
                }
                for (var e = 1; e < a; e++) {
            ...
            buildStyleHtml: function (b) {
                for (var b = [].concat(b), a, d = [], h = 0; h < b.length; h++)
                    if (a = b[h]) /@import|[{}]/.test(a) ? d.push("<style>" + a + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                return d.join("")
            },
            ...
            normalizeCssText: function (a, c) {
                var d = [],
                    h, e = CKEDITOR.tools.parseCssText(a, true, c);
            ...
            var b = this.$.cloneNode(a),
                c = function (d) {
                    ...
                    if (d.nodeType == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (a)
                            for (var d = d.childNodes, b = 0; b < d.length; b++) c(d[b])
                    }
                };
            c(b);
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getByAddress: function (a, e) {
            for (var b = this.$.documentElement, c =
                ...
                var d = a[c];
                if (e)
                    for (var h = -1, g = 0; g < b.childNodes.length; g++) {
    ...
    (function () {
        ...
        function b(a) {
            for (var b = 0, e = 0, n = c[a].length; e < n; e++) b = b + (parseInt(this.getComputedStyle(c[a][e]) || 0, 10) || 0);
            return b
        }
            ...
            removeStyle: function (a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++)
                        if (e)
                            for (var j = 0; j < e.length; j++) b.push([a, c[i], e[j]].join("-"));
            ...
            copyAttributes: function (a,
                ...
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    var i = c[e],
                        ...
                        o;
                    if (!(j in b))
                        if (j == "checked" && (o = this.getAttribute(j))) a.setAttribute(j, o);
                        else if (i.specified || CKEDITOR.env.ie && i.nodeValue && j == "value") {
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                ...
                this._.guardLTR = function (a, b) {
                    return (!b || !r.equals(a)) && (!i || !a.equals(i)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            ...
            if (this.current) f = this.current[h](false, t, k);
            else {
                if (a) f.type ==
                    CKEDITOR.NODE_ELEMENT && (f = e > 0 ? f.getChild(e - 1) : k(f, true) === false ? null : f.getPreviousSourceNode(true, t, k));
                else {
                    f = d;
    ...
    (function () {
            ...
            a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset
                ...
                if (f.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (h >= f.getChildCount()) {
                        ...
                        k = true
                    } else f = f.getChild(h).getPrevious();
                    else {
                ...
                for (c = t; c < m.length; c++) {
                    ...
                    if (!h[c] || j.$.parentNode != h[c].$.parentNode)
                        for (j = j.getPrevious(); j;) {
                            if (j.equals(h[c]) || j.equals(f)) break;
                            E = j.getPrevious();
                            if (b == 2) g.$.insertBefore(j.$.cloneNode(true), g.$.firstChild);
                            else {
                                j.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function (a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    if (r.type == CKEDITOR.NODE_TEXT) {
                        ...
                        if (r && !(l = r.getPrevious())) k = r.getParent()
                    } else {
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                                ...
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    /[^\s\ufeff]/.test(j) && (l = null);
                                    r = /[\s\ufeff]$/.test(j)
                                } else if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark"))
                                    if (i && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                        j = l.getText();
                                        if (/[^\s\ufeff]/.test(j)) l = null;
                                        else
                                            for (var g = l.$.getElementsByTagName("*"), n = 0, E; E = g[n++];)
                    ...
                    t = i = false;
                    if (r.type == CKEDITOR.NODE_TEXT) {
                        r = !CKEDITOR.tools.trim(r.substring(j)).length && r;
                        i = !(r && r.getLength());
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var z, M, Q = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                            br: 1
                        } : null),
                        v = null,
                        w = function (a) {
            ...
            shrink: function (a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (e && e.type == CKEDITOR.NODE_TEXT)
                        if (m)
                            if (m >= e.getLength()) d.setEndAfter(e);
                            else {
                                d.setEndAfter(e);
                                l = 0
            ...
            removeEmptyBlocksAtEnd: function () {
                ...
                return function (b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, m; e && !e.equals(d.root) && !e.getFirst(a(e));) {
                        m = e.getParent();
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; p;) {
                    var y = 0,
                        m = p.hasAscendant("pre"),
                        k = p.type != CKEDITOR.NODE_ELEMENT,
                        l = 0;
                    if (k) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (k = 0);
                    else {
                        var t = p.getName();
                        if (CKEDITOR.dtd.$block[t] && p.getAttribute("contenteditable") == "false") {
                            ...
                            c(this, a, b);
                            break
                        } else if (p.isBlockBoundary(this.forceBrBreak && !m && {
                            br: 1
                        })) {
                            if (t == "br") k = 1;
                            else if (!g && !p.getChildCount() &&
                                t != "hr") {
                                b = p;
                                q = p.equals(f);
                                break
                    ...
                    if (g && !y)
                        for (; !p.getNext(n) && !q;) {
                            t = p.getParent();
                            if (t.isBlockBoundary(this.forceBrBreak && !m && {
                                br: 1
                            })) {
                                y = 1;
                                k = 0;
                ...
                if (!b) {
                    ...
                    b = b.block;
                    if (!b && p && !this.enforceRealBlocks && y[p.getName()] && g.checkStartOfBlock() && g.checkEndOfBlock() && !p.equals(g.root)) b = p;
    ...
    (function () {
                    ...
                    a: if (a.nothingRequired) f = true;
                        ...
                        if (k = a.requiredClasses) {
                            ...
                            for (f = 0; f < k.length; ++f)
                                if (CKEDITOR.tools.indexOf(m, k[f]) == -1) {
                                    f = false;
                                    break a
                                }
                        }
                ...
                if (e) {
                    ...
                    if (!e.allAttributes)
                        for (A in r)
                            if (!h[A])
                                if (s.test(A)) {
                                    if (A != (z = A.replace(/^data-cke-saved-/, "")) && !h[z]) {
                                        delete r[A];
                                        q = true
                                    }
                                } else {
            ...
            if (t.$empty[d] || !a.children.length)
                ...
                if (b == "br") {
                    ...
                    if (f) {
                        ...
                        f = a.parent;
                        for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", l, k = d.length; k > 0;) {
                            m = d[--k];
                            if (e && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && t.$inline[m.name])) {
                                ...
                                f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (m.type ==
                                    CKEDITOR.NODE_ELEMENT && !t[f.name][m.name]) && c.push({
                                    check: "el-up",
                                    el: m
                                })
                            }
            ...
            for (e in d)
                if (e == "class") {
                    ...
                    for (m = a.classes.join("|"); l =
                        c.pop();)
                        if (m.indexOf(l) == -1) return false
                } else if (a.attributes[e] != d[e]) return false;
            for (k in f)
                if (a.styles[k] != f[k]) return false;
            return true
        }
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function (a, b, d, e) {
                        ...
                        a: {
                            ...
                            if (p)
                                for (e = 0; e < p.length; ++e)
                                    if ((C = d.match(p[e])) && C[0].length == d.length) {
                                        c = true;
                                        break a
                                    }
                ...
                k.length && (g = true);
                for (var r, a = [], e = A[e || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; d = k.pop();) d.type == CKEDITOR.NODE_ELEMENT ? f(d, e, a) : d.remove();
                for (; r = a.pop();) {
                    d = r.el;
                    ...
                    case "el-up":
                        ...
                        break;
                    case "parent-down":
                        d.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !t[d.parent.name][d.name] && f(d.parent, e, a)
                    }
                }
                return g
            },
            ...
            check: function (a, b, d) {
                ...
                if (CKEDITOR.tools.isArray(a)) {
                    for (var f = a.length; f--;)
                        if (this.check(a[f], b, d)) return true;
                    return false
                }
                var e, k;
                if (typeof a == "string") {
        ...
        load: function (a, e, b) {
            ...
            CKEDITOR.scriptLoader.load(h, function (a, d) {
                ...
                for (var h = 0; h < a.length; h++)
                    for (var f = g[a[h]], p = 0; p < f.length; p++) {
                        var i = f[p];
                        n[i] = this.get(i);
                        c[i] = 1
                    }
            ...
            var h = {}, g = function (b) {
                    a.call(this, b, function (a) {
                        ...
                        for (n in a) {
                            ...
                            if (!e[n]) {
                                if (q.icons)
                                    for (var u = q.icons.split(","), f = u.length; f--;) CKEDITOR.skin.addIcon(u[f], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + u[f] + ".png");
                                e[n] = 1
                            }
                            if (s) {
                                s.split && (s = s.split(","));
    ...
    (function () {
        function a(a, c, h) {
            ...
            if (c !== void 0) {
                ...
                if (!(h == CKEDITOR.ELEMENT_MODE_INLINE ? c.is(CKEDITOR.dtd.$editable) || c.is("textarea") : h == CKEDITOR.ELEMENT_MODE_REPLACE ? !c.is(CKEDITOR.dtd.$nonBodyContent) : 1)) throw Error('The specified element mode is not supported on element: "' + c.getName() + '".');
                this.element = c;
                this.elementMode = h;
        ...
        function h(a) {
            ...
            if (c.fn) {
                ...
                (CKEDITOR.getUrl(a.config.customConfig) == b || !h(a)) && a.fireOnce("customConfigLoaded")
        ...
        function o(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                CKEDITOR.scriptLoader.load(k, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], k = 0; k < c.length; k++)
                        for (var m =
                            0; m < d.length; m++) {
                            var l = d[m];
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, h, g) {
                ...
                if (a(f)) p.push(f);
                    ...
                    if (d == "pre") l =
                        ...
                        for (;;) {
                            ...
                            if (!f.isUnknown && !m.isUnknown && !g[d])
                                if (m.isOptionalClose) u.onTagClose(h);
                                ...
                                "li" ? "ul" : "dl", {}, 0, 1);
                            else if (h in e && !s(d, h)) {
                                !f.returnPoint && (f.returnPoint = m);
                                m = m.parent
                            } else {
                                h in CKEDITOR.dtd.$inline && p.unshift(m);
                                if (m.parent) o(m, m.parent, 1);
                                else {
                                    f.isOrphan = 1;
                                    break
                                }
            ...
            u.onText = function (a) {
                ...
                var d = m.name,
                    f = d ? CKEDITOR.dtd[d] || (m._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!k && !f["#"] && d in e) {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onElement: function (a, c) {
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, g = 0; g < 3; g++)
                        if (e = d[g]) {
                            e = e.exec(a, c, this);
    ...
    (function () {
        function a(a, e) {
                ...
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [],
                            ...
                            g, C;
                        if (l)
                            for (m(l, 1) && k.push(l); l;) {
                                if (h(l) && (g = c(l)) && m(g))
                                    if ((C = c(g)) && !h(C)) k.push(g);
                                    else {
                                        f(v).insertAfter(g);
                                        g.remove()
                                    }
                        ...
                        if (k = CKEDITOR.env.opera && !a || (typeof d == "function" ? d(e) !==
                            false : d))
                            if (!v && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) k = false;
                            else if (!v && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem)) k = false;
                        else {
                            k = b(e);
            ...
            function m(a, b) {
                ...
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y))) {
                    ...
                    if (!v)
                        if ((c = a.previous) && c.name == "br" || !c || h(c)) return true
                }
                return false
            }
            var r = {
        ...
        var y = /(?:&nbsp;|\xa0)$/,
            ...
            t = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block),
            x = {
                elements: {
                    input: n,
                    textarea: n
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            split: function (a) {
                for (var b = this.children.splice(a, this.children.length - a), e = this.clone(), g = 0; g < b.length; ++g) b[g].parent = e;
                e.children = b;
            ...
            getFilterContext: function (a) {
                ...
                if (b.length)
                    for (var a = CKEDITOR.tools.copy(a), e = 0; e < b.length; e = e + 2) a[b[e]] = b[e +
                        1];
                return a
            }
        }, true)
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, h = c.count(); d < h; d++) {
                    a = c.getItem(d);
                    if (a.getAttribute("contenteditable") == "true") {
                        e = {
                            element: a,
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function (a, b) {
                    ...
                    if (l)
                        for (;
                            (g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[d]);)
                            if (g.getName() in CKEDITOR.dtd.span) b.splitElement(g);
                ...
                insertElementIntoSelection: function (a) {
                    var b = this.editor,
                        ...
                        d = b.getRanges()[0],
                        k = a.getName(),
                        k = CKEDITOR.dtd.$block[k];
                    g(this);
                    if (this.insertElementIntoRange(a, d)) {
                        d.moveToPosition(a, CKEDITOR.POSITION_AFTER_END);
                        if (k)
                            if ((k = a.getNext(function (a) {
                                return c(a) && !i(a)
                            })) && k.type == CKEDITOR.NODE_ELEMENT && k.is(CKEDITOR.dtd.$block)) k.getDtd()["#"] ? d.moveToElementEditStart(k) : d.moveToElementEditEnd(a);
                            else if (!k && e != CKEDITOR.ENTER_BR) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in k) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) || (d = h(b))) {
                                    ...
                                    if ((i = g.block) && (n = i[c ? "getPrevious" : "getNext"](o)) && n.type == CKEDITOR.NODE_ELEMENT && n.is("table") &&
        ...
        var s = function () {
            ...
            function b(c, e) {
                var d, k, m, l, h = [],
                    i = e.range.startContainer;
                d = e.range.startPath();
                for (var i = g[i.getName()], r = 0, j = c.getChildren(), n = j.count(), o = -1, q = -1, x = 0, s = d.contains(g.$list); r < n; ++r) {
                    d = j.getItem(r);
                    if (a(d)) {
                        m = d.getName();
            ...
            function l(b, c) {
                ...
                var d = c.endContainer.getChild(c.endOffset),
            ...
            var g = CKEDITOR.dtd,
                h = {
                    ...
                    h5: 1,
                    h6: 1
                }, i = CKEDITOR.tools.extend({}, g.$inline);
            delete i.br;
            return function (h,
                j, o) {
                var q = h.editor;
                h.getDocument();
                var x = q.getSelection().getRanges()[0],
                    s = false;
                ...
                if (!x.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(x.startContainer, x.root)).blockLimit || x.root,
                        j = {
                            type: j,
                            dontFilter: s,
                            editable: h,
                    ...
                    if (!q.collapsed) {
                        var v = C.block || C.blockLimit,
                            X = q.getCommonAncestor();
                        v && (!v.equals(X) && !v.contains(X) && q.checkEndOfBlock()) && j.zombies.push(v);
                        q.deleteContents()
                    }
                    for (;
                        (D = a(q.startContainer) && q.startContainer.getChild(q.startOffset - 1)) && a(D) && D.isBlockBoundary() && H.contains(D);) q.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    if (w) {
                        ...
                        for (l(H, F); w < H.length; w++) {
                            ...
                            if (B = C.isLineBreak) {
                                ...
                                if (C.hasBlockSibling) B = 1;
                                    ...
                                    if (!N || !N.is({
                                        ...
                                        U = N.getPosition(K);
                                        if (U == CKEDITOR.POSITION_IDENTICAL || U == CKEDITOR.POSITION_CONTAINS) B = 0;
                                        else {
                                            K = B.splitElement(N);
                            ...
                            if (B) s = w > 0;
                                ...
                                B = F.startPath();
                                if (!C.isBlock && j.editor.config.autoParagraph !== false && (j.editor.activeEnterMode != CKEDITOR.ENTER_BR && j.editor.editable().equals(B.blockLimit) && !B.block) && (O = j.editor.activeEnterMode != CKEDITOR.ENTER_BR && j.editor.config.autoParagraph !== false ? j.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false)) {
                                    O = u.createElement(O);
                                    O.appendBogus();
                                    F.insertNode(O);
                                ...
                                if (S) {
                                    ...
                                    S = 0
                                } else F.insertNode(C.node); if (C.lastNotAllowed && w < H.length - 1) {
                    ...
                    for (S = J.createBookmark(); G = j.zombies.pop();)
                        if (G.getParent()) {
                            O = J.clone();
                    ...
                    if (R)
                        for (; G = R.pop();) CKEDITOR.env.needsBrFiller ? G.appendBogus() : G.append(J.document.createText(" "));
            ...
            u = function () {
                ...
                return function (e) {
                    var d = e.startContainer,
                        l = d.getAscendant("table", 1),
                        g = false;
    ...
    (function () {
        ...
        function c(a) {
            ...
            var c = a.startContainer,
                e = a.getPreviousNode(s, null, c),
                d = a.getNextNode(s, null, c);
            ...
            if (c) {
                if (b !== false) {
                    var e, d = a.getDocument().getSelection().getNative(),
                        f = d && d.type != "None" && d.getRangeAt(0);
        ...
        function i(a) {
            ...
            var c = a.getSelection(),
                e = a.createRange(),
                d = c.root.on("selectionchange", function (a) {
                    a.cancel()
                }, null, null, 0);
            ...
            return function (c) {
                ...
                if (b[e]) {
                    var d = a.getSelection().getRanges(),
                        f = d[0];
                    if (d.length == 1 && f.collapsed)
                        if ((e = f[e < 38 ? "getPreviousEditableNode" : "getNextEditableNode"]()) && e.type == CKEDITOR.NODE_ELEMENT && e.getAttribute("contenteditable") == "false") {
        ...
        var o, q, s = CKEDITOR.dom.walker.invisible(1),
            u = function () {
                function a(b) {
                    return function (a) {
        ...
        var f = typeof window.getSelection != "function",
            p = 1;
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && n(a, b);
                ...
                if (f) b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && n(a, null, true);
                else {
            ...
            var g, h;
            if (d)
                if (d.getRangeAt) g = (h = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(h.commonAncestorContainer);
                else {
                    try {
                        h = d.createRange()
                    } catch (j) {}
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function () {
                var a = f ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (var e = d.children, f, g, h = b.duplicate(), l = 0, m = e.length - 1, j = -1, i, o; l <= m;) {
                                j = Math.floor((l + m) / 2);
                                f = e[j];
                            ...
                            return {
                                container: o,
                                offset: i > 0 ? -h : o.nodeValue.length + h
                            }
                        };
                        return function () {
                            ...
                            if (d ==
                                ...
                                for (var d = [], e = 0; e < c.length; e++) {
                                    for (var f = c.item(e), k = f.parentNode, g = 0, a = new CKEDITOR.dom.range(this.root); g < k.childNodes.length && k.childNodes[g] != f; g++);
                        ...
                        for (var d = c.ranges, e = 0; e < d.length; e++) {
                            ...
                            if (!f.collapsed) {
                                if (f.startContainer.isReadOnly())
                                    for (var b = f.startContainer, g; b;) {
            ...
            getSelectedElement: function () {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function () {
                        ...
                        function () {
                            for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && y[c.getName()] && (d = c))); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                            return d && d.$
                        });
            ...
            getSelectedText: function () {
                ...
                var b = this.getNative(),
                    b = f ? b.type == "Control" ? "" : b.createRange().text : b.toString();
            ...
            unlock: function (a) {
                if (this.isLocked) {
                    ...
                    c = !b && this.getRanges(), d = this.isFake;
                    this.isLocked = 0;
                    this.reset();
                        ...
                        if (b) this.fake(b);
                            ...
                            if (f) {
                                ...
                                if (n && n.type == CKEDITOR.NODE_ELEMENT &&
                                    ...
                                    o.select();
                                    return
                                } catch (q) {}(b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in g || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in g) && b.shrink(CKEDITOR.NODE_ELEMENT, true);
                                o = b.createBookmark();
                                var g = o.startNode,
                                    p;
                                if (!a) p = o.endNode;
    ...
    CKEDITOR.editor.prototype.attachStyleStateChange = function (a, e) {
        ...
        if (!b) {
            ...
            this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var e = b[d],
                        g = e.style.checkActive(a.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    e.fn.call(this, g)
                }
            })
        }
    ...
    (function () {
        ...
        function e(b) {
            ...
            if (b.collapsed) {
                ...
                var f = this.element,
                    g = this._.definition,
                    h, j = g.ignoreReadonly,
                    i = j || g.includeReadonly;
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        if (p && i && CKEDITOR.dtd.$block[s])
                            for (var t = n, x = c(t), z = void 0, A = x.length, I = 0, t = A && new CKEDITOR.dom.range(t.getDocument()); I < A; ++I) {
                                var z = x[I],
                                    L = CKEDITOR.filter.instances[z.data("cke-filter")];
                                if (L ? L.check(this) : 1) {
                        ...
                        if (x)
                            if ((x = n.getParent()) && ((x.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(x))) {
                                ...
                                if (s == CKEDITOR.NODE_TEXT || p || s == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                    for (var s = n, W;
                                        (j = !s.getNext(E)) && (W = s.getParent(), k[W.getName()]) && (W.getPosition(m) | Q) == Q && (!g.childRule || g.childRule(W));) s = W;
                                    q.setEndAfter(s)
                                }
                            } else j = true;
                            else j = true;
                        ...
                        for (var j = y(this, d), p = j.hasAttributes(), r = q.getCommonAncestor(), s = {}, x = {}, z = {}, A = {}, T, P, Z; j && r;) {
                            if (r.getName() == f) {
                                for (T in g.attributes)
                                    if (!A[T] &&
                                        (Z = r.getAttribute(P))) j.getAttribute(T) == Z ? x[T] = 1 : A[T] = 1;
                                for (P in g.styles)
                                    if (!z[P] && (Z = r.getStyle(P))) j.getStyle(P) == Z ? s[P] = 1 : z[P] = 1
                            }
                            r = r.getParent()
                        }
        ...
        function b(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(k.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) {
                    var h = a.elements[g];
            ...
            var c = a.createBookmark(),
                d = c.startNode;
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, j = 0, h; j < e.elements.length && (h = e.elements[j]); j++) {
        ...
        function s(a, b) {
            var c = this._.definition,
                ...
                h;
            for (h in d)
                if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != t(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
                    g = a.hasAttribute(h);
                    a.removeAttribute(h)
                }
            for (var j in c)
                if (!(this._.definition.fullMatch && a.getStyle(j) != t(j, c[j], true))) {
                    g = g || !! a.getStyle(j);
                    a.removeStyle(j)
                }
            f(a, e, r[a.getName()]);
    ...
    (function () {
        function a(a, c, d) {
            var e = a.serializable,
                g = c[d ? "endContainer" : "startContainer"],
...
*/
                ...
                uiElement: function (a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        var i = (e.call ? e(b) : e) || "div",
                            l = ["<", i, " "],
                            k = (d && d.call ? d(b) : d) || {}, h = (g && g.call ? g(b) : g) || {}, o = (f && f.call ? f.call(this, a, b) : f) || "",
    ...
    CKEDITOR.plugins.add("forms", {
        ...
        init: function (b) {
            ...
            var i = b.plugins.image;
            i && !b.plugins.image2 && d("ImageButton", "imagebutton", CKEDITOR.plugins.getPath("image") + "dialogs/image.js");
            ...
            b.addMenuItems && (d = {
                ...
                b.addMenuItems(d));
            b.contextMenu && (!b.blockless && b.contextMenu.addListener(function (g, c, b) {
                if ((g = b.contains("form", 1)) && !g.isReadOnly()) return {
                ...
                if (b && !b.isReadOnly()) {
                    ...
                    if (c == "img" && b.data("cke-real-element-type") == "hiddenfield") return {
