...
<head>
   <meta charset="utf-8" />
   <title>404 Page - philtyphils</title>
...
.metro-nav .metro-nav-block.lantai {
    width: 30%;
	height:245px;
}


.metro-nav .metro-nav-block.infosaham {
    width: 30%;
	height:245px;
}

.metro-nav .metro-nav-block.absensi {
    width: 30%;
	height:500px;
}

.metro-nav .metro-nav-block.news {
    width: 38%;
	height:500px;
}

.metro-nav .metro-nav-block.runingteks {
    width: 100%;
	height:50px;
}
...
#header.navbar-inverse .navbar-inner {
    ...
    background-image: -moz-linear-gradient(top, #900, #900);
    background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#900), to(#900));
    background-image: -webkit-linear-gradient(top, #900, #900);
    background-image: -o-linear-gradient(top, #900, #900);
...
.about-us h4, .team-member h3, .team-member ul li a:hover, .contact-us h4 {
   ...
   <link href="metrolab/css/bootstrap-responsive.min.css" rel="stylesheet" />
   <link href="metrolab/font-awesome/css/font-awesome.css" rel="stylesheet" />
...
<body class="error-404">
    <div class="error-wrap">
        ...
        <p>Follow : <a href="javascript:;">@philtyphils</a> on Twitter, Thank you. </p>
